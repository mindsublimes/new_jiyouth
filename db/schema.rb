...
ActiveRecord::Schema.define(version: 2023_02_14_103202) do
  ...
  create_table "responsibility_sessions", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["responsibility_id"], name: "index_responsibility_sessions_on_responsibility_id"
    t.index ["team_member_id"], name: "index_responsibility_sessions_on_team_member_id"
  end
